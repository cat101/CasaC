...
public:
    ...
    int timerBeingCalled; // This value can be used by the callback function to find which timer expired
    ...
    void restartTimer(int numTimer, long d=-1);
