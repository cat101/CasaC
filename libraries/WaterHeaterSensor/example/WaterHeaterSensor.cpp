...
const int inPin = 2; //This is hard coded for now...it should really be WATER_TANK_SENSOR
...
//     }
//    }  
//    DEBUG_PRINT_P("Water Sensor disconected? (pin=%hd, started %lu, end %lu, val1=%u)\n",inPin,st,millis(),val1);
//    return false;
// }
