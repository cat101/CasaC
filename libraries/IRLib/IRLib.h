...
enum IRTYPES {UNKNOWN, NEC, SONY, RC5, RC6, PANASONIC_OLD, JVC, NECX, DAIKIN, HASH_CODE, LAST_PROTOCOL=HASH_CODE};
...
class IRsendDaikin: public virtual IRsendBase
{
public:
  void send(unsigned char buf[], int len, int start);
};
class IRsendAIWA: public virtual IRsendBase
{
public:
...
public virtual IRsendDaikin,
public virtual IRsendAIWA
{
public:
